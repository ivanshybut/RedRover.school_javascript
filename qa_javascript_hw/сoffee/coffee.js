// Напешите пошаговый алгоритм приготовления кофе и выведите его на экран(страницу)
...
let order = `You choosed a ${cup} of ${coffee}`;
...
let step5 = 5 + "Stil coffee in a cup with a spoon"
